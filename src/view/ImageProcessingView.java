...
public class ImageProcessingView extends JFrame implements ViewInterface {
  ...
  private void initializeComponents() {
    ...
    enableSplitToggleButton("GREYSCALE");

    openButton = new JButton("Open Image");
    saveButton = new JButton("Save Image");
    new JButton("Process Image");

    String[] options = new String[]{
        "GREYSCALE", "SEPIA", "BLUR", "SHARPEN", "VALUE_COMPONENT",
        "INTENSITY_COMPONENT", "LUMA_COMPONENT", "RED_COMPONENT", "GREEN_COMPONENT",
        "BLUE_COMPONENT", "BRIGHTEN", "HORIZONTAL_FLIP", "VERTICAL_FLIP",
        "COLOR_CORRECT", "LEVELS_ADJUST", "IMAGE_COMPRESSION", "DITHERING"};
  ...
  private void toggleSplitView() {
    if (splitToggleButton.isSelected()) {
      ...
      applyPreviewButton.setEnabled(false);
      splitToggleButton.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
    }
  }
  ...
  private BufferedImage applyFilter(String filter, String inputFileName, String outputFileName) {
    ...
    switch (filter) {
      ...
      case "IMAGE_COMPRESSION":
        userInput = openDialogBox("Enter the parameter:");
      ...
      case "LEVELS_ADJUST":
        ...
        do {
          userInput1 = openDialogBox("Enter black value:");
          userInput2 = openDialogBox("Enter mid value:");
          userInput3 = openDialogBox("Enter white value:");
          checkValid = checkValidInput(userInput1, userInput2, userInput3);
        }
        while (checkValid);
  ...
  private void enableSplitToggleButton(String selectedFilter) {
    ...
    String[] filtersToEnableSplitButton = {"SEPIA", "BLUR", "GREYSCALE", "SHARPEN", "LEVELS_ADJUST","COLOR_CORRECT"};
  ...
  private void updateSplitView() {
    ...
    if (splitVal > 0 && splitVal < 100) {
      ...
      String selectedFilter = (String) filterComboBox.getSelectedItem();
      String inputFileName = (isImageModified()) ? "image-filter" : "image";
